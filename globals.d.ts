declare namespace Spotifier {
	...
	namespace Player {
		...
		const origin: any;
		/**
		 * Register a listener `type` on Spotifier.Player.
		 *
		 * On default, `Spotifier.Player` always dispatch:
		...
		/**
		 * Dispatches an event at `Spotifier.Player`.
		 *
		 * On default, `Spotifier.Player` always dispatch
		 *  - `songchange` type when player changes track.
		 *  - `onplaypause` type when player plays or pauses.
	 ...
	 *
	 * Spotifier.Keyboard is wrapper of this library to be compatible with legacy Spotify,
	...
	namespace ReactComponent {
		type ContextMenuProps = {
			 ...
			 */
			menu:
				| typeof Spotifier.ReactComponent.Menu
				| typeof Spotifier.ReactComponent.AlbumMenu
				| typeof Spotifier.ReactComponent.PodcastShowMenu
				| typeof Spotifier.ReactComponent.ArtistMenu
				| typeof Spotifier.ReactComponent.PlaylistMenu;
			/**
		 ...
		 *
		 * Props:
		 * @see Spotifier.ReactComponent.ContextMenuProps
		 */
		 ...
		 *
		 * Props:
		 * @see Spotifier.ReactComponent.MenuProps
		 */
		const Menu: any;
		/**
		 ...
		 *
		 * Props:
		 * @see Spotifier.ReactComponent.MenuItemProps
		 */
		const MenuItem: any;
		/**
		 ...
		 *
		 * Props:
		 * @see Spotifier.ReactComponent.TooltipProps
		 */
		 ...
		 *
		 * Props:
		 * @see Spotifier.ReactComponent.IconComponentProps
		 */
		 ...
		 *
		 * Props:
		 * @see Spotifier.ReactComponent.TextComponentProps
		 */
		 ...
		 *
		 * Props:
		 * @see Spotifier.ReactComponent.ConfirmDialogProps
		 */
		 ...
		 *
		 * Props:
		 * @see Spotifier.ReactComponent.SliderProps
		 */
		const Slider: any;
		/**
		 ...
		 *
		 * Props:
		 * @see Spotifier.ReactComponent.ButtonProps
		 */
	...
	const Tippy: any;
	/**
	 * Spotifier's predefined props for Tippy.js
	...
	/**
	 * Spotifier's QraphQL wrapper for Spotify's GraphQL API endpoints
	 */
	namespace GraphQL {
		/**
		 ...
		 * @description A preinitialized version of `Spotifier.GraphQL.Handler` using current context.
