const ProviderNetease = (() => {
	...
	async function findLyrics(info) {
		...
		const searchResults = await Spotifier.CosmosAsync.get(finalURL, null, requestHeader);
		...
		return await Spotifier.CosmosAsync.get(lyricURL + items[itemId].id, null, requestHeader);
	}
