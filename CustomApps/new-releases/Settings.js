...
function openConfig() {
	const configContainer = react.createElement(
		...
		react.createElement(OptionList, {
			items: [
				...
				{
					desc: Spotifier.Locale.get("artist.albums"),
					key: "album",
				...
				{
					desc: Spotifier.Locale.get("artist.singles"),
					key: "single-ep",
				...
				/* {
					desc: Spotifier.Locale.get("artist.appears-on"),
					key: "appears-on",
				...
				{
					desc: Spotifier.Locale.get("artist.compilations"),
					key: "compilations",
		...
		react.createElement(
			...
			react.createElement(
				...
				react.createElement(ButtonText, {
					text: Spotifier.Locale.get("equalizer.reset"),
	...
	Spotifier.PopupModal.display({
		title: Spotifier.Locale.get("new_releases"),
